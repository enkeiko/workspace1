  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        throw new Error(result.error?.message || "작업 생성에 실패했습니다.");
      }
    } catch (error) {
    ...
    <MainLayout>
      <div className="container mx-auto p-6">
        <div className="mb-6 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold">작업 추가</h1>
            <p className="text-gray-500">새로운 작업을 등록합니다.</p>
          </div>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>작업의 기본 정보를 입력하세요.</CardDescription>
          </CardHeader>
          <CardContent>

...
📎 **Guidebook 전략**: [D-Sys (내부 콘텐츠 전략)](251113_Guidebook_v1.1_full.md#d-내부-콘텐츠-전략-intro--news--visual), [C-4 (콘텐츠 삽입 규칙)](251113_Guidebook_v1.1_full.md#c-4-콘텐츠-삽입-규칙)
📎 **이전 단계**: [L2 분석 및 목표키워드 설정](l2-analysis.md)
...
**Guidebook 관점**: 이 단계는 **D-Sys (내부 콘텐츠 전략)**에 따라 소개문/소식/시각콘텐츠에 키워드를 삽입하는 전략을 생성합니다.
...
**Guidebook 용어**: 이 실행 계획은 **D-Sys (내부 콘텐츠 전략)** 구성 요소를 반영합니다:
- **D-Sys-Intro** (소개문): 메타태그 최적화, 키워드 자연스러운 포함
- **D-Sys-News** (소식): 블로그 포스팅, SNS 포스팅
- **D-Sys-Visual** (시각콘텐츠): 전문 사진 촬영, 메뉴판 배치

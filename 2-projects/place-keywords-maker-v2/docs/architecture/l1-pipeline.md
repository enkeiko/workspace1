...
📎 **Guidebook 전략**: [C-Sys-0 (Meta 수집)](251113_Guidebook_v1.1_full.md#c-3-c-sys-키워드-자동화-구조), [C-Sys-1 (매핑)](251113_Guidebook_v1.1_full.md#c-3-c-sys-키워드-자동화-구조), [B-3 (NAP 관리)](251113_Guidebook_v1.1_full.md#b-상호명--카테고리-전략)
📎 **다음 단계**: [L2 분석 및 목표키워드 설정](l2-analysis.md)
...
**Guidebook 관점**: 이 단계는 **C-Sys-0 (Meta 수집)**과 **C-Sys-1 (매핑)**을 구현합니다.
...
**Guidebook 용어**: 이 단계는 **C-Sys-1 (매핑)** - 리뷰·메뉴·소식에서 자연어 추출 및 클러스터링을 구현합니다. 아래 요소들은 Guidebook의 **keyword_meta_taxonomy.yaml** 구조(지역/대상/의도/감성/시점)를 반영합니다.
